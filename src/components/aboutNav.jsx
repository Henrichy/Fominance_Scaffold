...
function AboutHead() {
    return (
      ...
      <Link to="/" className="text-white flex justify-center items-center h-full">
        BUY GIFTCARDS
      </Link>
      ...
      <Link to="/about" className="border-b-2 border-yellow-400 text-white flex justify-center items-center h-full">
        COMPANY
      </Link>
